...
// Data file
// Writing form data to local file located on your server
// allow writing data to file
$allow_writing_data_to_file = 0; //default: 0
// set the name and path to your file
$file_name = "../user_subscriptions.txt"; // default: "../user_subscriptions.txt"
// header of data block in file
$data_header = $mail_subject;
// body of data block
$data_body = 
"
Client's name: $_POST[$html_field_name]
Client's Email: $_POST[$html_field_email]
Client's phone number: $_POST[$html_field_phone]
Request details: $_POST[$html_field_mailbody]
